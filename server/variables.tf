...
variable "vswitch_cidr_rabbitmq" {
  type = "list"
  default = ["172.16.20.0/24", "172.16.21.0/24", "172.16.22.0/24"]
}

variable "vswitch_cidr_db_service" {
  type = "list"
  default = ["172.16.30.0/24", "172.16.31.0/24", "172.16.32.0/24"]
}
...
variable "rabbitmq_gateway" {
  type = "list"
  default = ["172.16.20.1", "172.16.21.1", "172.16.22.1"]
}

variable "db_service_gateway" {
  type = "list"
  default = ["172.16.30.1", "172.16.31.1", "172.16.32.1"]
}
